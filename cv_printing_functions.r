...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$soft        <- read_gsheet(sheet_id = "soft_skills")
    cv$hard        <- read_gsheet(sheet_id = "hard_skills")
...
sanitize_links <- function(cv, text){
  if(cv$pdf_mode){
    ...
    n_new_links <- length(link_destinations)
...
print_skill_bars <- function(cv, out_of = 3, bar_color = "lightpink", bar_background = "white", glue_template = "default"){
...
#' @description Construct a bar chart of skills
#' @param out_of The relative maximum for skills. Used to set what a fully filled in skill bar is.
print_hard_bars <- function(cv, out_of = 3, bar_color = "lightpink", bar_background = "white", glue_template = "default"){
...
#' @description Construct a bar chart of skills
#' @param out_of The relative maximum for skills. Used to set what a fully filled in skill bar is.
print_soft_bars <- function(cv, out_of = 3, bar_color = "lightpink", bar_background = "white", glue_template = "default"){
