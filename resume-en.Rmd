...
position_data <- read.csv2('./data/position_data_en.csv', stringsAsFactors = F)
...
if(params$doctype == "HTML"){
  cat("[<i class='fas fa-download'></i> Download as a PDF](https://github.com/biamuniz/resume/raw/main/bianca_muniz_resume_english.pdf)")
}
...
## Voluntary work {data-icon="award" data-concise="true"}
