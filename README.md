...
This repo has all the code and data to render my resume in R with [pagedown package](https://pagedown.rbind.io) and it was an adaption of https://mleary.github.io/resume/ with my personal data.
